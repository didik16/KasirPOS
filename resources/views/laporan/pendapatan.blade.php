        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table cellspacing="0" class="table table-bordered" id="dataTable">
                    ...
                    <tbody>
                        @foreach ($pendapatan as $i => $u)
                            <tr>
                                <td>{{ ++$i }}</td>
                                <td>{{ $u->total_transaksi }}</td>
                                <td>{{ number_format($u->total_jumlah_beli) }}</td>
                                <td>{{ number_format($u->total_harga_semua) }}</td>
                                <td>{{ date('d/m/Y', strtotime($u->tanggal)) }}</td>
                                {{-- <td><a class="btn btn-primary btn-sm ml-2"
                                        href="/laporan/{{ $u->kode_transaksi_kembalian }}">View</a></td> --}}
                            </tr>
                        @endforeach
                        {{-- </tbody> --}}
                </table>
