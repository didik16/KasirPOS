                    ...
                    <tbody>
                        @foreach ($kategori as $i => $u)
                            <tr>
                                ...
                                <td><a href="/kategori/edit/{{ $u->id_kategori }}"
                                        class="btn btn-primary btn-sm ml-2">Edit</a>
                                    <button class="btn btn-danger btn-sm ml-2 btn_remove" data-id="{{ $u->id_kategori }}"
                                        route="{{ route('kategori.destroy') }}">Hapus</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
